...
export default function ShareInvitationCard({ eventId }: ShareInvitationCardProps) {
  ...
  return (
    <div className="bg-sunlight/15 ring-sunlight/30 rounded-sm p-6 ring-1">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="border-border bg-card text-foreground hover:bg-secondary press rounded-sm border px-4 py-2.5 text-sm font-semibold transition-all"
          >
            Preview ↗
          </a>
        </div>
