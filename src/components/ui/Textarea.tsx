    ...
    return (
      <div className="w-full">
        ...
        <textarea
          ref={ref}
          id={textareaId}
          className={`text-foreground placeholder:text-muted-foreground disabled:bg-muted disabled:text-muted-foreground bg-card block min-h-[80px] w-full resize-y rounded-2xl border px-4 py-3 text-base transition-all duration-200 focus:ring-0 focus:outline-none disabled:cursor-not-allowed ${
            error
